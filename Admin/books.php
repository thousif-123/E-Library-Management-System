    ...
    <div id="main">
        ...
        if(isset($_POST['submit'])) {
            ...
            if(mysqli_num_rows($q)==0) {
                ...
                echo "<th>"; echo "Action"; echo "</th>"; // New column for action
                echo "</tr>";    
                while($row=mysqli_fetch_assoc($q)) {
                    ...
                    echo "<td><a href='readpdf.php?bid=".$row['bid']."'>Read</a> | <a href='booksedit.php?bid=".$row['bid']."'>Edit</a> | <a href='booksdelete.php?bid=".$row['bid']."'>Delete</a></td>"; // Edit and delete links
                    echo "</tr>";
                }
                echo "</table>";
            }
