...
if(isset($_POST['submit'])) {
    ...
    $query = "UPDATE admin SET first='$first', last='$last',username='$username', password='$password' , email='$email', contact='$contact' WHERE username='$username'";
    $result = mysqli_query($db, $query);
